...
<script src="https://cdn.jsdelivr.net/gh/Keillion/easy-barcode-scanner@10.2.1000/dist/easy-barcode-scanner.js" data-license=""></script>
<script>
...
dynamsoft.config.ts, you can import it in `main.ts`.
```ts
